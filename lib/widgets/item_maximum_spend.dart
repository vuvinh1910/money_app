    ...
    try {
      ...
      if (_spendLimit.type == SpendLimitType.WEEKLY) {
        ...
        return scale >= 0
            ...
            : (offset > 20 ? EdgeInsets.only(right: offset - 20) : EdgeInsets.zero);
      }
  ...
  Widget build(BuildContext context) {
    ...
    void _nav() {
      Navigator.push(
        context,
        MaterialPageRoute(
          builder: (context) => SpendLimitPage(_spendLimit),
        ),
      );
    }
    ...
    return FutureBuilder(
      ...
      builder: (BuildContext context, AsyncSnapshot snapshot) {
        if (snapshot.hasError) {
          ...
          final int remaining = _spendLimit.amount - spent;
            ...
            children: <Widget>[
                  ...
                  children: <Widget>[
                    ...
                    Expanded(
                      ...
                      child: Column(
                        ...
                        children: <Widget>[
                          Text(
                            '${textToCurrency(_spendLimit.amount.toString())} đ',
                            style: Theme.of(context).textTheme.titleMedium,
                          ),
                        ],
                      ),
              ...
              Container(
                ...
                child: LinearProgressIndicator(
                  ...
                  value: spent >= _spendLimit.amount
                      ? 1.0
                      : spent / _spendLimit.amount,
                ),
              ),
